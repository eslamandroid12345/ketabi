...
@section('title', __('dashboard.content') . ' ' . __('dashboard.privacyPolicy'))
...
@section('content')
    ...
    <section class="content-header">
        <div class="container-fluid">
            <div class="row mb-2">
                <div class="col-sm-6">
                    <h1>@lang('dashboard.privacyPolicy')</h1>
                </div>
            </div>
        </div><!-- /.container-fluid -->
    </section>
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('privacy-terms.store') }}" method="post" autocomplete="off"
                              enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.privacyPolicy')</h3>
                            </div>
                            @csrf
                            <div class="card-body" id="privacyPolicy">
                                <!-- Hero Section -->
                                @if(isset($content['en']))
                            ...
                            <div class="col-1">
                                <div id="add_privacyPolicy" style="cursor: pointer;"><i style="color: green"
...
@section('js_addons')
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#add_privacyPolicy').click(function () {
                index++
                ...
                $('#privacyPolicy').append(newAchievement);
