...
@section('title', __('dashboard.Create') . ' ' . __('dashboard.educational_stages'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('educational-stages.store') }}" method="post" autocomplete="off"
                            enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Create') @lang('dashboard.educational_stage')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputNameEn1">@lang('dashboard.Name En')</label>
                                            <input name="name_en" type="text" class="form-control"
                                                id="exampleInputNameEn1" value="{{ old('name_en') }}" placeholder=""
                                                required>
                                        </div>
                                    </div>
                                </div>
