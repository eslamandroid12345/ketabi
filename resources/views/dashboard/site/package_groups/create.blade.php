...
@section('title', __('dashboard.Create') . ' ' . __('dashboard.package group'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('groups.store', $package_id) }}" method="post" autocomplete="off"
                            enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Create') @lang('dashboard.package group')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="seats" type="number" class="form-control"
                                                   id="exampleInputEmail1" value="{{ old('seats') ?? $package->default_seats }}"
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="whatsapp_group" type="url" class="form-control"
                                                   id="exampleInputEmail1" value="{{ old('whatsapp_group') }}"
                                                   placeholder="" required>
                                        </div>
                                    </div>
                                </div>
