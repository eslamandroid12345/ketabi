...
@section('title', __('titles.Create package_category'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('package-categories.store') }}" method="post" autocomplete="off"
                            enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('dashboard.Create') @lang('dashboard.package_category')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
