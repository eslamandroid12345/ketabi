...
@section('title', __('titles.Edit lecture'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('lectures.update', $lecture) }}" method="post" autocomplete="off"
                            enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('titles.Edit lecture')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                @method('put')
                                        ...
                                        <div class="col-6">
                                            <div class="form-group">
                                                ...
                                                <input name="minutes" type="number" class="form-control"
                                                    id="exampleInputEmail1" value="{{ $lecture->minutes }}" placeholder=""
                                                    required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_ar" type="text" class="form-control" id="exampleInputName1"
                                                value="{{ $lecture->name_ar }}" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="name_en" type="text" class="form-control"
                                                id="exampleInputEmail1" value="{{ $lecture->name_en }}" placeholder=""
                                                required>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <select name="platform" class="form-control" required>
                                                ...
                                                <option
                                                    {{ old('platform') == 'youtube' || ($lecture->platform == 'youtube' ? 'selected' : '') }}
                                                    value="youtube">@lang('dashboard.youtube')</option>
                                                <option
                                                    {{ old('platform') == 'vimeo' || ($lecture->platform == 'vimeo' ? 'selected' : '') }}
                                                    value="vimeo">@lang('dashboard.vimeo')</option>
                                                <option
                                                    {{ old('platform') == 'swarmify' || ($lecture->platform == 'swarmify' ? 'selected' : '') }}
                                                    value="swarmify">@lang('dashboard.swarmify')</option>
                                                <option
                                                    {{ old('platform') == 'zoom' || ($lecture->platform == 'zoom' ? 'selected' : '') }}
                                                    value="zoom">@lang('dashboard.zoom')</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="link" type="text" class="form-control" id="exampleInputName1"
                                                value="{{ $lecture->link }}" placeholder="" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                        ...
                                        <div class="form-group clearfix mb-0">
                                            <div class="icheck-primary d-flex">
                                                <input name="is_live" type="checkbox" id="checkboxPrimary1"
                                                    {{ old('is_live') == 'on' ? 'checked' : ($lecture->is_live ? 'checked' : '') }}>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input name="show_in_profile" type="checkbox" id="checkboxPrimary2"
                                                    {{ old('show_in_profile') == 'on' ? 'checked' : ($lecture->show_in_profile ? 'checked' : '') }}>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input name="show_in_package" type="checkbox" id="show_in_package"
                                                    {{ old('show_in_package') == 'on' ? 'checked' : ($lecture->show_in_package ? 'checked' : '') }}>
                                        ...
                                        <div class="form-group clearfix">
                                            <div class="icheck-primary d-inline">
                                                <input name="is_active" type="checkbox" id="checkboxPrimary4"
                                                    {{ old('is_active') == 'on' ? 'checked' : ($lecture->is_active ? 'checked' : '') }}>
