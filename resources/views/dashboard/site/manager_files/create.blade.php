...
@section('title', __('titles.Create file'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('manager-files.store') }}" method="post" autocomplete="off"
                            enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('titles.Create')@lang('dashboard.file')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <label for="exampleInputFile">@lang('dashboard.file')</label>
                                <div class="row">
                                    <div class="col-10">
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="pages_count" type="number" class="form-control"
                                                id="exampleInputName1" value="{{ old('pages_count') }}" placeholder=""
                                                required>
                                        </div>
                                    </div>
                                    <div class="col-6">
