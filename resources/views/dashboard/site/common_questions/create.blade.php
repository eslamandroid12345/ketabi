...
@section('title', __('titles.Create common_question'))
    ...
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('common-questions.store') }}" method="post" autocomplete="off"
                            enctype="multipart/form-data">
                            <div class="card-header">
                                <h3 class="card-title">@lang('titles.Create')@lang('dashboard.common_question')</h3>
                            </div>
                            <div class="card-body">
                                @csrf
                                <div class="row">
                                ...
                                <div class="row">
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input name="answer_ar" type="text" class="form-control" id="exampleInputName1"
                                                value="{{ old('answer_ar') }}" placeholder="" required>
                                        </div>
                                    </div>
                                    <div class="col-6">
                                        <div class="form-group">
                                            <label for="exampleInputEmail1">@lang('dashboard.answer_en')</label>
                                            <input name="answer_en" type="text" class="form-control"
                                                id="exampleInputEmail1" value="{{ old('answer_en') }}" placeholder=""
                                                required>
                                        </div>
                                    </div>
                                </div>
